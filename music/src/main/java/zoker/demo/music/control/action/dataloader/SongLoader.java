package zoker.demo.music.control.action.dataloader;
...
//        return SongLoader.getSongsForCursor(retCursor);
        return SongLoader.getSongsForCursor(null);
    }
...
//                        song.setPlayCountScore(scoreCursor.getFloat(scoreCursor.getColumnIndex(SongPlayCount.SongPlayCountColumns.PLAYCOUNTSCORE)));
                        song.setPlayCountScore(scoreCursor.getFloat(scoreCursor.getColumnIndex(null)));
                        arrayList.add(song);
                    }
...
//        final String songSortOrder = PreferencesUtility.getInstance(context).getSongSortOrder();
        final String songSortOrder=null;
